    ...
    <div className="popup">
      ...
      >
        ...
        <p style={{ fontSize: "27px", color: "#667479", margin: "0" }}>
          ...
          emphasizing learnability and usuablity. This page features projects
          that utilize HTML, CSS, design skills, and even CSS. Hope you enjoy
        ...
        <p style={{ fontSize: "27px", color: "#667479", margin: "0" }}>
          ...
          experience that could have been improved from my point of view. Yet
          after taking this course I feel competent enough to provide even
          better peer review. Although this was my first formal education of
          UIUX, I did have some prior knowledge to developing a website but I
          believe this class was a great opportunity to experiment web page
          development that people may otherwise not have enough time to commit
          to this tasks.
        </p>
        <br></br>
        <h1 style={{ fontSize: "60px", color: "#49565B", marginTop: "0" }}>
